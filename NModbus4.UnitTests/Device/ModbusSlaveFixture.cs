...
public class ModbusSlaveFixture
{
    ...
    {
        ReadCoilsInputsResponse expectedResponse = new(Modbus.ReadCoils, 1, 2,
    ...
    {
        ReadCoilsInputsResponse expectedResponse = new(Modbus.ReadInputs, 1, 2,
    ...
    public void ReadRegistersHoldingRegisters()
    {
        ReadHoldingInputRegistersResponse expectedResponse =
            new(Modbus.ReadHoldingRegisters, 1,
    ...
    {
        ReadHoldingInputRegistersResponse expectedResponse =
            new(Modbus.ReadInputRegisters, 1,
    ...
    public void WriteMultipCoils_MakeSureWeDoNotWriteRemainder()
    {
        ...
        WriteMultipleCoilsRequest? request = new WriteMultipleCoilsRequest(1, 0,
