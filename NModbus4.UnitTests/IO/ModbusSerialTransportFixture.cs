...
public class ModbusSerialTransportFixture
{
    ...
    {
        ModbusAsciiTransport? transport = new ModbusAsciiTransport(StreamResource) { CheckFrame = true };
    ...
    {
        ModbusAsciiTransport? transport = new ModbusAsciiTransport(StreamResource) { CheckFrame = false };
    ...
    public void UnicastMessage_PurgeReceiveBuffer()
    {
        ...
        ModbusRtuTransport? transport = new ModbusRtuTransport(serialResource);
