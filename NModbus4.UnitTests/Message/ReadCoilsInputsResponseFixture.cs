...
namespace Modbus.UnitTests.Message
{
    public class ReadCoilsInputsResponseFixture
    {
        ...
        {
            ReadCoilsInputsResponse response = new(Modbus.ReadCoils, 5, 2,
            ...
            DiscreteCollection col = new(true, true, true, true, true, true, false, false, true, true,
                false);
        ...
        {
            ReadCoilsInputsResponse response = new(Modbus.ReadInputs, 5, 2,
                new DiscreteCollection(true, true, true, true, true, true, false, false, true, true, false));
